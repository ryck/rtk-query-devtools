  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-16 sm:py-20">
      ...
      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
        Every card below dispatches real requests against the same in-memory
        fake API, one column through RTK Query and one through TanStack Query,
        covering arguments, mutations, errors, polling, and pagination. Open the
        devtools panel in the bottom-right corner and switch between the two
        plugin tabs to compare them.
      </p>
