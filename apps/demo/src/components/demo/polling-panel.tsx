  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Subscribes to the same <code>listPosts</code> cache entry with a 3s
          poll interval. The Queries tab shows a "polling" pill on this entry
          while active.
        </CardDescription>
      </CardHeader>
